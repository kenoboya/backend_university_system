...
func (s *EmployeesService) GetById(ctx context.Context, id int64) (model.Employee, error) {
	return s.repo.GetById(ctx, id)
}
func (s *EmployeesService) Update(ctx context.Context, id int64, employee model.UpdateEmployeeInput) error {
	return s.repo.Update(ctx, id, employee)
}
func (s *EmployeesService) Delete(ctx context.Context, id int64) error {
