...
type Students interface {
	...
	GetStudentBriefInfoById(ctx context.Context, id uint64) (model.StudentBriefInfo, error)
	GetStudentFullInfoById(ctx context.Context, id uint64) (model.StudentFullInfo, error)
	GetStudentsAttendanceByLessonID(ctx context.Context, lesson_id uint64) ([]model.AttendanceRecord, error)
	GetStudentsGradesByLessonID(ctx context.Context, lesson_id uint64) ([]model.Grade, error)
}
...
type Users interface {
	...
	SetSession(ctx context.Context, id uint64, session model.Session) error
	GetByRefreshToken(ctx context.Context, refreshToken string) (model.User, error)
	UpdateRole(ctx context.Context, role string, user_id uint64) error
}
type Admins interface {
	BlockUser(ctx context.Context, id uint64) error
	UnblockUser(ctx context.Context, id uint64) error
}
type People interface {
	...
	GetPersonByUserID(ctx context.Context, userID uint64) (model.Person, error)
	...
	GetApplicationsByUserID(ctx context.Context, userID uint64) ([]model.PersonApplication, error)
	GetApplicationByID(ctx context.Context, applicationID uint64) (model.PersonApplication, error)
	UpdateApplicationStatus(ctx context.Context, status string, id uint64) error
...
type Teachers interface {
	...
	Delete(ctx context.Context, id uint64) error
	GetTeacherBriefInfoById(ctx context.Context, id uint64) (model.TeacherBriefInfo, error)
	GetTeacherFullInfoById(ctx context.Context, id uint64) (model.TeacherFullInfo, error)
...
type Subjects interface {
	...
	Delete(ctx context.Context, id uint64) error
	GetSubjectsByStudentID(ctx context.Context, student_id uint64) ([]model.Subject, error)
}
type Lessons interface {
	...
	Delete(ctx context.Context, id uint64) error
	GetLessonsByStudentID(ctx context.Context, student_id uint64, timeNow time.Time) ([]model.Lesson, error)
	GetLessonsByTeacherID(ctx context.Context, teacher_id uint64) ([]model.Lesson, error)
}
...
type News interface {
	...
	GetById(ctx context.Context, id uint64) (model.News, error)
	Update(ctx context.Context, id uint64, news model.UpdateNewsInput) error
	Delete(ctx context.Context, id uint64) error
}
...
type Complaints interface {
	...
	Response(ctx context.Context, id uint64, response string) error
}
